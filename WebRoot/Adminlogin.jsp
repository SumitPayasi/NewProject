...
<div id="header">
    ...
    <div id="logo">
		<h1 align="center">&nbsp;</h1>
		<p align="center">&nbsp;</p>
		<div align="center"><strong><span class="style5">ADMIN LOGIN </span></strong></div>
	  </div>   
</div>
 ...
 <div id="main">
   <div id="top">
     <div id="left">
       ...
       <p align="center" class="style6"></p>
       <form name="Userlogin" id="aloginform" method="post" action="LoginAdminServlet2" onsubmit="return validate();">
         <table width="522" height="167" border="0" align="center">
           <tr>
             <td height="73">Admin Id </td>
